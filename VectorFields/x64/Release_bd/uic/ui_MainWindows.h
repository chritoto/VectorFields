...
public:
    ...
    QWidget *renderer;
    QWidget *layoutIsolate;
    QHBoxLayout *horizontalLayout_19;
    QLabel *sectionsType;
    QLabel *labelsection;
    QLabel *voxelsSection;
    QLabel *label_14;
    QSlider *GroupSlider;
    ...
    void setupUi(QMainWindow *MainWindowsClass)
    {
        ...
        layoutIsolate = new QWidget(renderBox);
        layoutIsolate->setObjectName(QString::fromUtf8("layoutIsolate"));
        layoutIsolate->setEnabled(false);
        horizontalLayout_19 = new QHBoxLayout(layoutIsolate);
        horizontalLayout_19->setSpacing(6);
        horizontalLayout_19->setContentsMargins(11, 11, 11, 11);
        horizontalLayout_19->setObjectName(QString::fromUtf8("horizontalLayout_19"));
        sectionsType = new QLabel(layoutIsolate);
        sectionsType->setObjectName(QString::fromUtf8("sectionsType"));

        horizontalLayout_19->addWidget(sectionsType);

        labelsection = new QLabel(layoutIsolate);
        labelsection->setObjectName(QString::fromUtf8("labelsection"));

        horizontalLayout_19->addWidget(labelsection);

        voxelsSection = new QLabel(layoutIsolate);
        voxelsSection->setObjectName(QString::fromUtf8("voxelsSection"));

        horizontalLayout_19->addWidget(voxelsSection);

        label_14 = new QLabel(layoutIsolate);
        ...
        verticalLayout_4->addWidget(layoutIsolate);
    ...
    void retranslateUi(QMainWindow *MainWindowsClass)
    {
        ...
        sectionsType->setText(QCoreApplication::translate("MainWindowsClass", "0", nullptr));
        labelsection->setText(QCoreApplication::translate("MainWindowsClass", "# sections of selected type", nullptr));
        voxelsSection->setText(QCoreApplication::translate("MainWindowsClass", "0", nullptr));
        label_14->setText(QCoreApplication::translate("MainWindowsClass", "# voxels in the selected section", nullptr));
