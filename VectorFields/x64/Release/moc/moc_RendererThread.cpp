...
QT_MOC_LITERAL(1, 9, 11), // "viewChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5) // "value"

    },
    "Renderer\0viewChanged\0\0value"
};
...
void Renderer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Renderer::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Renderer::viewChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Renderer::viewChanged(int _t1)
{
